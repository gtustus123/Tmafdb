...
class RegionsApiController extends Controller
{
    public function index()
    {
        ...
        return new RegionResource(Region::with(['identifier', 'localisation_type', 'region_source'])->get());
    }
    ...
    public function show(Region $region)
    {
        ...
        return new RegionResource($region->load(['identifier', 'localisation_type', 'region_source']));
    }
