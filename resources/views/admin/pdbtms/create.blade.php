...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pdbtm.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pdbtms.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="matrix">{{ trans('cruds.pdbtm.fields.matrix') }}</label>
                <input class="form-control {{ $errors->has('matrix') ? 'is-invalid' : '' }}" type="number" name="matrix" id="matrix" value="{{ old('matrix', '1') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('transmembrane') ? 'is-invalid' : '' }}" name="transmembrane" id="transmembrane" required>
                    ...
                    @foreach(App\Models\Pdbtm::TRANSMEMBRANE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('transmembrane', 'no') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qvalue') ? 'is-invalid' : '' }}" type="number" name="qvalue" id="qvalue" value="{{ old('qvalue', '0.00') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tmtype') ? 'is-invalid' : '' }}" name="tmtype" id="tmtype" required>
                    ...
                    @foreach(App\Models\Pdbtm::TMTYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tmtype', 'Tm_Alpha') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('x') ? 'is-invalid' : '' }}" type="number" name="x" id="x" value="{{ old('x', '0.000') }}" step="0.00000001" required>
                @if($errors->has('x'))
                    <div class="invalid-feedback">
                        {{ $errors->first('x') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('y') ? 'is-invalid' : '' }}" type="number" name="y" id="y" value="{{ old('y', '0.000') }}" step="0.00000001" required>
                @if($errors->has('y'))
                    <div class="invalid-feedback">
                        {{ $errors->first('y') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('z') ? 'is-invalid' : '' }}" type="number" name="z" id="z" value="{{ old('z', '0.000') }}" step="0.00000001" required>
                @if($errors->has('z'))
                    <div class="invalid-feedback">
                        {{ $errors->first('z') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('xx') ? 'is-invalid' : '' }}" type="number" name="xx" id="xx" value="{{ old('xx', '1.000') }}" step="0.00000001" required>
                @if($errors->has('xx'))
                    <div class="invalid-feedback">
                        {{ $errors->first('xx') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('xy') ? 'is-invalid' : '' }}" type="number" name="xy" id="xy" value="{{ old('xy', '0.000') }}" step="0.00000001" required>
                @if($errors->has('xy'))
                    <div class="invalid-feedback">
                        {{ $errors->first('xy') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('xz') ? 'is-invalid' : '' }}" type="number" name="xz" id="xz" value="{{ old('xz', '0.000') }}" step="0.00000001" required>
                @if($errors->has('xz'))
                    <div class="invalid-feedback">
                        {{ $errors->first('xz') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('xt') ? 'is-invalid' : '' }}" type="number" name="xt" id="xt" value="{{ old('xt', '0.000') }}" step="0.00000001" required>
                @if($errors->has('xt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('xt') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yx') ? 'is-invalid' : '' }}" type="number" name="yx" id="yx" value="{{ old('yx', '0.000') }}" step="0.00000001" required>
                @if($errors->has('yx'))
                    <div class="invalid-feedback">
                        {{ $errors->first('yx') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yy') ? 'is-invalid' : '' }}" type="number" name="yy" id="yy" value="{{ old('yy', '1.000') }}" step="0.00000001" required>
                @if($errors->has('yy'))
                    <div class="invalid-feedback">
                        {{ $errors->first('yy') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yz') ? 'is-invalid' : '' }}" type="number" name="yz" id="yz" value="{{ old('yz', '0.000') }}" step="0.00000001" required>
                @if($errors->has('yz'))
                    <div class="invalid-feedback">
                        {{ $errors->first('yz') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yt') ? 'is-invalid' : '' }}" type="number" name="yt" id="yt" value="{{ old('yt', '0.000') }}" step="0.00000001" required>
                @if($errors->has('yt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('yt') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zx') ? 'is-invalid' : '' }}" type="number" name="zx" id="zx" value="{{ old('zx', '0.000') }}" step="0.00000001" required>
                @if($errors->has('zx'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zx') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zy') ? 'is-invalid' : '' }}" type="number" name="zy" id="zy" value="{{ old('zy', '0.000') }}" step="0.00000001" required>
                @if($errors->has('zy'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zy') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zz') ? 'is-invalid' : '' }}" type="number" name="zz" id="zz" value="{{ old('zz', '1.000') }}" step="0.00000001" required>
                @if($errors->has('zz'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zz') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zt') ? 'is-invalid' : '' }}" type="number" name="zt" id="zt" value="{{ old('zt', '0.000') }}" step="0.00000001" required>
                @if($errors->has('zt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('zt') }}
                    </div>
