...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.newChainMatrix.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.new-chain-matrices.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformxx') ? 'is-invalid' : '' }}" type="number" name="transformxx" id="transformxx" value="{{ old('transformxx', '1.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformxy') ? 'is-invalid' : '' }}" type="number" name="transformxy" id="transformxy" value="{{ old('transformxy', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformxz') ? 'is-invalid' : '' }}" type="number" name="transformxz" id="transformxz" value="{{ old('transformxz', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformxt') ? 'is-invalid' : '' }}" type="number" name="transformxt" id="transformxt" value="{{ old('transformxt', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformyx') ? 'is-invalid' : '' }}" type="number" name="transformyx" id="transformyx" value="{{ old('transformyx', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformyy') ? 'is-invalid' : '' }}" type="number" name="transformyy" id="transformyy" value="{{ old('transformyy', '1.000') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformyz') ? 'is-invalid' : '' }}" type="number" name="transformyz" id="transformyz" value="{{ old('transformyz', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformyt') ? 'is-invalid' : '' }}" type="number" name="transformyt" id="transformyt" value="{{ old('transformyt', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformzx') ? 'is-invalid' : '' }}" type="number" name="transformzx" id="transformzx" value="{{ old('transformzx', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformzy') ? 'is-invalid' : '' }}" type="number" name="transformzy" id="transformzy" value="{{ old('transformzy', '0.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformzz') ? 'is-invalid' : '' }}" type="number" name="transformzz" id="transformzz" value="{{ old('transformzz', '1.000') }}" step="0.00000001" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transformzt') ? 'is-invalid' : '' }}" type="number" name="transformzt" id="transformzt" value="{{ old('transformzt', '0.000') }}" step="0.00000001" required>
